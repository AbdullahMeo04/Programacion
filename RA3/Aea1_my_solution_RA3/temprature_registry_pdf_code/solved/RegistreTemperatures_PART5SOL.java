...
public class RegistreTemperatures_PART5SOL {
  //Constants
  ...
  public static void main (String[] args) {
    RegistreTemperatures_PART5SOL programa = new RegistreTemperatures_PART5SOL();
    programa.inici();
  }

  public void inici() {
    while (!fi) { // !: no sigui cert --> mentre fi no sigui cert
      mostrarMenu();
      tractarOpcio();
    }
  }
